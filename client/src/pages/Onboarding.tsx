          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-8">
                <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-800 flex items-center justify-center">
          ...
          {step === 3 && (
            ...
            <div className="space-y-8 max-w-lg">
              ...
              <div className="space-y-6">
                ...
                <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v)=>updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories you aim to burn through and activity each day."/>
              </div>
            </div>

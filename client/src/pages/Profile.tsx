...
const Profile = () => {
  ...
  const [formData, setFormData ] = useState<ProfileFormData>({age: 0, weight: 0, goal: 'maintain', dailyCalorieIntake: 2000, dailyCalorieBurn: 400 })
      ...
      <div className="profile-content">
        ...
        <div className="space-y-4">
          ...
          <div className="lg:hidden">
            <button onClick={toggleTheme} className="flex items-center gap-3 px-4 py-2.5 w-full text-slate-500 dark:text-slate-400 dark:hover:text-slate-200 rounded-lg transition-colors duration-200 cursor-pointer">

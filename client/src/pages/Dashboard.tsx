...
import { type ActivityEntry, type FoodEntry } from "../types"
import Card from "../components/ui/Card"
import ProgressBar from "../components/ui/ProgressBar"
import { ActivityIcon, Car, FlameIcon, HamburgerIcon, Ruler, ScaleIcon, TrendingUpIcon, ZapIcon } from "lucide-react"
    ...
    <div className="page-container">
      ...
      <div className="dashboard-grid">
        ...
        <Card className="col-span-2">
          <h3 className="font-semibold text-slate-800 dark:text-white mb-2">This Week's Progres</h3>
          <CaloriesChart/>
        </Card>
      </div>
    </div>

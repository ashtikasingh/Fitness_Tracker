      ...
      <main className="login-page-container">
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <p className="mt-2 text-sm text-gray-500/90 dark:text-gray-400">
            ...
            {state !== 'login' && (
              <div className="mt-4">
                <label className="font-medium text-sm text-gray-700 dark:text-gray-300 siz">Username</label>
            ...
            {/* Email */}
             <div className="mt-4">
                <label className="font-medium text-sm text-gray-700 dark:text-gray-300 siz">Email</label>
                <div className="relative mt-2">
              ...
              {/* Password */}
             <div className="mt-4">
                <label className="font-medium text-sm text-gray-700 dark:text-gray-300 siz">Password</label>
                <div className="relative mt-2">
                  <LockIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 size-4.5"/>
                  <input onChange={(e)=>setPassword(e.target.value)} value={password} placeholder="Enter your Password" className="login-input pr-10" required type = {showPassword ? 
                  'text' : 'password'
                  }/>
